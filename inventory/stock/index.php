    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <a href="index.php"><img src="log1.jpg" alt="" width="100%"></a>
            </div>
            <div class="main-menu">
...
<br>
                    ...
                    <div class="img-button d-flex justify-content-evenly" data-aos="zoom-in" data-aos-duration="2000">
                        <a href="stock.php" title="image 1" class="stock-img-button"><img src="../folder1.png" class="rounded" alt="Stock Barang"></a>
                        <a href="masuk.php"><img src="../import1.png" class="rounded" alt="Barang Masuk"></a>
                        <a href="keluar.php"><img src="../export1.png" class="rounded" alt="Barang Keluar"></a>
                    </div>
