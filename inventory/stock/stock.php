...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update sstock_brg set nama='$nama', jenis='$jenis', merk='$merk', ukuran='$ukuran', stock='$stock', satuan='$satuan', lokasi='$lokasi' where idx='$idx'");
                            ...
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
                                        ...
                                        <tfoot style="background-color: #333; color: #fff;">
                                            <tr>
                                                <th colspan="5">Total Stock</th>
                                                <th colspan="3"><?= $total_stock ?></th>
                                                <th colspan="">Unit/Buah</th>
                                            </tr>
                                        </tfoot>
										</table>
                                    </div>
