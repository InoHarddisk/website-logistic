...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        if($jumlah >= $qtyskrg){
            ...
            $updatedata1 = mysqli_query($conn,"update sbrg_masuk set  tgl=NOW(),jumlah='$jumlah',keterangan='$keterangan' where id='$id'");
            ...
            $updatedata = mysqli_query($conn,"update sbrg_masuk set tgl=NOW(), jumlah='$jumlah', keterangan='$keterangan' where id='$id'");
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
									...
									<a href="exportbrgmsk.php" target="_blank" class="btn btn-info mt-3">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
