...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        if($jumlah >= $qtyskrg){
            ...
            $updatedata1 = mysqli_query($conn,"update sbrg_keluar set tgl=NOW(),jumlah='$jumlah',penerima='$penerima',keterangan='$keterangan' where id='$id'");
            ...
            $updatedata = mysqli_query($conn,"update sbrg_keluar set tgl=NOW(), jumlah='$jumlah', penerima='$penerima', keterangan='$keterangan' where id='$id'");
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="log1.jpg" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
                        ...
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                ...
                                <ul class="active">
                                    ...
                                    <li class="active"><a href="keluar.php"><i class="ti-export"></i><span>Barang Keluar</span></a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <h2 id="jam-digital"></h2>
                                    <script>
                                        function tampilkanJam() {
                                            ...
                                            document.getElementById("jam-digital").innerHTML = (jam < 10 ? "0" + jam : jam) + ":" + (menit < 10 ? "0" + menit : menit) + ":" + (detik < 10 ? "0" + detik : detik);
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right" style="color:black; padding:0px;">
                            <img src="log1.jpg" width="220px" class="user-name dropdown-toggle" data-toggle="dropdown"\>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
									...
									<a href="exportbrgklr.php" target="_blank" class="btn btn-info mt-3">Export Data</a>
                                </div>
                            </div>
                        </div>
                    </div>
